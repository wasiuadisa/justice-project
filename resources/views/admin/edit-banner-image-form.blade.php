                        ...
                        <div class="card mb-3 mb-md-4">
                            <form class="form ml-5" method="post" action="{{ route('admin.store_banner_home_image_form') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <img src="{{ asset('storage/public_template/images') . '/' . $image_contents->banner_image }}" alt="{{ htmlspecialchars_decode($image_contents->banner_image) }}" width="80%" height="80%" />
                                </div>
                                <div class="form-group ">
