<?php
    ...
    $imageSpecificAsString = ucwords(implode(' ', explode("_", Str::kebab($resource_contents->id))));
?>
    ...
    <div class="content">
        <div class="py-4 px-3 px-md-4">
            ...
            <div class="mb-3 mb-md-4 d-flex justify-content-between">
                <div class="h3 mb-0">{{ htmlspecialchars_decode($resource_contents->fullname) }}</div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-3 mb-md-4">
                        ...
                        <div class="card mb-3 mb-md-4">
                            <form class="form ml-5" method="post" action="{{ $processingRoute }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="postID" value="{{ $resource_contents->id }}" />
                                <input type="hidden" name="postID" value="{{ $resource_contents->id }}" />
